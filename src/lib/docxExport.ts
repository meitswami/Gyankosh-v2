    ...
    sections: [{
      ...
      children: [
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: `Generated by Gyankosh 2.0 on ${new Date().toLocaleDateString()}`,
              size: 20,
              color: '666666',
            }),
          ],
...
export async function exportExcelChatToDocx(
  ...
  messages.forEach((msg, idx) => {
    children.push(
      new Paragraph({
        text: msg.role === 'user' ? '📝 Your Question:' : '🤖 Analysis:',
        heading: HeadingLevel.HEADING_2,
  ...
  children.push(
    new Paragraph({
      children: [
        new TextRun({
          text: `Exported from Gyankosh 2.0 on ${new Date().toLocaleDateString()}`,
          size: 20,
          color: '666666',
        }),
      ],
